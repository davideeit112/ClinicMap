...
public class EMessageDao {
	...
	public List<EMessage> querymsg1() {
		...
		Query<EMessage> query = session.createQuery("from EMessage where clinicID='3801012398' order by evaluationTime desc", EMessage.class);
		System.out.println("2..");
	...
	public List<EMessage> querymsg2() {
		Session session = sessionfactory.getCurrentSession();
		Query<EMessage> query = session.createQuery("from EMessage where clinicID='3801012399' order by evaluationTime desc", EMessage.class);
		List<EMessage> list = query.list();
		System.out.println(list);
		return list;
	}
	...
	public List<EMessage> querymsg3() {
		Session session = sessionfactory.getCurrentSession();
		Query<EMessage> query = session.createQuery("from EMessage where clinicID='3801012400' order by evaluationTime desc", EMessage.class);
		List<EMessage> list = query.list();
		System.out.println(list);
		return list;
	}	
